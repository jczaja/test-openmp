...
execute_process(COMMAND sudo perf stat -e imc0_data_reads,imc0_data_writes,imc1_data_reads,imc1_data_writes,imc4_data_reads,imc4_data_writes,imc5_data_reads,imc5_data_writes ${CMAKE_BINARY_DIR}/test-memory-traffic --num_reps ${num_reps} --algo=${ALGO} --batch_size=${N} --cold_caches=${COLD_CACHES} --channel_size=${C} --height=${H} --width=${W} 
OUTPUT_VARIABLE REGULAR_OUTPUT
ERROR_VARIABLE ANALYSIS_RESULT)
get_algorithm_info()
# Reads
