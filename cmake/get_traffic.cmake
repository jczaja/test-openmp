...
function(warmup_run)
execute_process(COMMAND ${CMAKE_BINARY_DIR}/test-memory-traffic --num_reps 10 --algo=${ALGO} --batch_size=${N} --cold_caches=false --channel_size=${C} --height=${H} --width=${W} --threading=${THREADING})
endfunction()

function(count_traffic num_reps data_reads data_writes)
message(STATUS "Batch Size: ${N}")
...
set(iter "1")
# For warm caches make some warmup run
