...
DATA_DIR="$PWD/experiment-latency-`date -I`"

if [ -d $DATA_DIR ] 
then
  echo "Directory $PWD/experiment-latency-`date -I` exists.  Quitting not too overwrite existing results." 
else
  ...
  cmake ../ -DCMAKE_BUILD_TYPE=Release -DALGO=dnnl_nchw_conv -DN=1 -DC=3 -DW=227 -DH=227 -DNF=96 -DHF=11 -DWF=11
  ...
  cmake ../ -DCMAKE_BUILD_TYPE=Release -DALGO=dnnl_nchw_conv -DN=1 -DC=3 -DW=227 -DH=227 -DNF=96 -DHF=11 -DWF=11 -DCOLD_CACHES=true
  sudo make enable_turbo_boost
  make -j 4 test-openmp-gomp
  sudo make disable_turbo_boost
  make roofline
  ...
  cmake ../ -DCMAKE_BUILD_TYPE=Release -DALGO=dnnl_blocked_conv -DN=1 -DC=3 -DW=227 -DH=227 -DNF=96 -DHF=11 -DWF=11 
  sudo make enable_turbo_boost
  make -j 4 test-openmp-gomp
  sudo make disable_turbo_boost
  make roofline
  ...
  cmake ../ -DCMAKE_BUILD_TYPE=Release -DALGO=dnnl_blocked_conv -DN=1 -DC=3 -DW=227 -DH=227 -DNF=96 -DHF=11 -DWF=11 -DCOLD_CACHES=true
  sudo make enable_turbo_boost
  make -j 4 test-openmp-gomp
  sudo make disable_turbo_boost
  make roofline
  ...
  cmake ../ -DCMAKE_BUILD_TYPE=Release -DALGO=dnnl_tnc_layer_norm -DN=1 -DC=768 -DW=4 -DH=32
  sudo make enable_turbo_boost
  make -j 4 test-openmp-gomp
  sudo make disable_turbo_boost
  make roofline
  ...
  cmake ../ -DCMAKE_BUILD_TYPE=Release -DALGO=dnnl_tnc_layer_norm -DN=1 -DC=768 -DW=4 -DH=32 -DCOLD_CACHES=true
  sudo make enable_turbo_boost
  make -j 4 test-openmp-gomp
  sudo make disable_turbo_boost
  make roofline
