...
then
  ...
  eltwise_experiment $DATA_DIR/dnnl_nchw_eltwise_warm_caches build-eltwise-nchw-warm-caches dnnl_nchw_eltwise false full
  eltwise_experiment $DATA_DIR/dnnl_nchw_eltwise_cold_caches build-eltwise-nchw-cold-caches dnnl_nchw_eltwise true full
  eltwise_experiment $DATA_DIR/dnnl_blocked_eltwise_warm_caches build-eltwise-blocked-warm-caches dnnl_blocked_eltwise false full
  eltwise_experiment $DATA_DIR/dnnl_blocked_eltwise_cold_caches build-eltwise-blocked-cold-caches dnnl_blocked_eltwise true full
  ...
  eltwise_experiment $DATA_DIR/dnnl_nchw_eltwise_warm_caches-socket build-eltwise-nchw-warm-caches-socket dnnl_nchw_eltwise false socket
  eltwise_experiment $DATA_DIR/dnnl_nchw_eltwise_cold_caches-socket build-eltwise-nchw-cold-caches-socket dnnl_nchw_eltwise true socket
  eltwise_experiment $DATA_DIR/dnnl_blocked_eltwise_warm_caches-socket build-eltwise-blocked-warm-caches-socket dnnl_blocked_eltwise false socket
  eltwise_experiment $DATA_DIR/dnnl_blocked_eltwise_cold_caches-socket build-eltwise-blocked-cold-caches-socket dnnl_blocked_eltwise true socket
  ...
  eltwise_experiment $DATA_DIR/dnnl_nchw_eltwise_warm_caches-single build-eltwise-nchw-warm-caches-single dnnl_nchw_eltwise false single
  eltwise_experiment $DATA_DIR/dnnl_nchw_eltwise_cold_caches-single build-eltwise-nchw-cold-caches-single dnnl_nchw_eltwise true single
  eltwise_experiment $DATA_DIR/dnnl_blocked_eltwise_warm_caches-single build-eltwise-blocked-warm-caches-single dnnl_blocked_eltwise false single
  eltwise_experiment $DATA_DIR/dnnl_blocked_eltwise_cold_caches-single build-eltwise-blocked-cold-caches-single dnnl_blocked_eltwise true single
fi
